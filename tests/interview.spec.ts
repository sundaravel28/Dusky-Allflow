...
const userDataDir = 'C:\\Users\\sundaravel.v\\Documents\\All Flow - Dusky\\C\\Users\\Windows\\AppData\\Local\\Google\\Chrome\\User Data\\Profile 1\\Profile 2';
...
test('Talent Hire - Interview Flow', async () => {
  ...
  console.log('Testing My Availability section...');
  await safeAction(page, async () => {
  ...
  }, 'Select Angular tech stack');

  await safeAction(page, async () => {
    await page.locator('div').filter({ hasText: /^Angular$/ }).click();
  ...
  await safeAction(page, async () => {
    await page.locator('div').filter({ hasText: /^Week$/ }).nth(2).click();
  }, 'Select Week view');
  ...
  // Reports Section
  console.log('Testing Reports section...');
  await safeAction(page, async () => {
